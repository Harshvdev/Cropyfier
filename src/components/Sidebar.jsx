      ...
      <div className="p-6 border-t border-gray-800 bg-gray-900/95 z-30 backdrop-blur">
        <div className="flex gap-2 mb-3">
          <button 
            ...
            className="flex-1 bg-white text-black hover:bg-blue-50 font-bold py-3.5 rounded-xl shadow-xl shadow-white/5 transition transform active:scale-[0.98] flex items-center justify-center gap-2 text-sm tracking-wide"
          >
            <span>⬇</span> Export
          </button>
          ...
          <button 
            ...
            className="w-16 bg-gray-800 border border-gray-700 text-white hover:bg-gray-700 font-bold rounded-xl flex items-center justify-center transition active:scale-95" 
