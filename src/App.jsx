          ...
          if (selectionChanged || modeChanged || activeChanged) {
              if (next.gridSplitActive && next.gridEditMode === 'individual') {
                  ...
                  const baselineAdjustments = {
                      ...
                      brushMode: next.globalSettingsBackup?.brushMode ?? "protect",
                      brushSize: next.globalSettingsBackup?.brushSize ?? 30,
                      brushVersion: next.globalSettingsBackup?.brushVersion ?? 0,
                      showBrushStrokes: next.globalSettingsBackup?.showBrushStrokes ?? true,
